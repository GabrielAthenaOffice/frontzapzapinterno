    ...
    return (
        <button
            ...
            className="group relative bg-white rounded-xl p-6 
                 border-2 border-gray-200 hover:border-blue-500 transition-all duration-300 
                 hover:shadow-xl hover:shadow-blue-500/20 hover:-translate-y-1 text-left w-full"
        >
            {/* Icon and Title */}
            ...
            {/* Hover Effect Border */}
            <div className="absolute inset-0 rounded-xl bg-blue-500 
